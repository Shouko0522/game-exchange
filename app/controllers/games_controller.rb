class GamesController < ApplicationController
  ...
  def create
    ...
    if @game.save
      redirect_to dashboard_path(dashboard), notice: 'Game was successfully created'
    else
      render 'new'
    end
  end
  ...
  def destroy
    @game = Game.find(params[:id])
    @game.destroy
    redirect_to dashboard_path(current_user), notice: 'Game was successfully destroyed'
  end
